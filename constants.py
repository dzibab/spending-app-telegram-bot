...
BOT_COMMANDS = {
    "start": {"command": "start", "description": "Start the bot", "help": "Start the bot and initialize your account"},
    "add_spending": {"command": "add_spending", "description": "Add a spending", "help": "Record a new expense"},
    "search_spending": {
        "command": "search",
        "description": "Search spendings",
        "help": "Search spendings by amount or description",
    },
    "add_category": {"command": "add_category", "description": "Add a category", "help": "Add a new spending category"},
    "remove_category": {
        "command": "remove_category",
        "description": "Remove a category",
        "help": "Remove an existing category",
    },
    "add_currency": {"command": "add_currency", "description": "Add a currency", "help": "Add a new currency"},
    "remove_currency": {
